...
/>
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Hi I'm Mamindla Pavan</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a 
              href="https://github.com/Pavan01Mamindla/portifolio/raw/main/[SUBFOLDER]/resume.docx" 
